...
const menu = {
    ...
    'Menu/Edit/Convert Selection to Patches': { path: ['Edit', 'Patches', 'Convert Selection to Patches'], shortcut: [ { key: 'P', modifiers: ['Ctrl', ] } ] },
    ...
    'Menu/Edit/Replace Material...': { path: ['Edit', 'Textures', 'Replace Material...'], shortcut: [ { key: '', modifiers: [] } ] },
    ...
    'Menu/Edit/Extract Linked Groups': { path: ['Groups', 'Extract Selected Objects'], shortcut: [ { key: '', modifiers: [] } ] },
    ...
    'Menu/Edit/Tools/Control Point Tool': { path: ['Tools', 'Control Point Tool'], shortcut: [ { key: 'P', modifiers: [] } ] },
